      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center space-y-8">
          ...
          <h2 className="cta-heading text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight">
            Orchestrate Your Revenue Future Today
          </h2>

          {/* Sub-headline */}
          <p className="cta-sub text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Deploy the world's most advanced autonomous revenue engine and close
            the gap between intent and attribution.
          </p>
          ...
          <div className="cta-button pt-4">
            <Link href="/plans">
              <button className="group relative inline-flex items-center gap-3 px-10 py-5 bg-linear-to-r from-blue-600 to-cyan-600 rounded-xl font-bold text-lg text-white shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/40 hover:scale-105 transition-all duration-300">
                <span>Initialize Revenue Engine</span>
