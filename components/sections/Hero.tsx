        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-blue-300">
                Next-Gen Revenue Orchestration
              </span>
            </motion.div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <br />
                <span className="text-white">Interaction Into</span>
                <br />
            ...
            <div className="flex flex-wrap gap-6 justify-center  lg:justify-start text-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="text-slate-300">4.2x ROAS Increase</span>
              </div>
              <div className="flex items-center gap-2">
                <Zap className="w-4 h-4 text-yellow-400" />
                <span className="text-slate-300">100% Autonomous</span>
              </div>
              <div className="flex items-center gap-2">
                <MessageSquare className="w-4 h-4 text-blue-400" />
                <span className="text-slate-300">Sub-second Response</span>
              </div>
            </div>
          ...
          <div className="relative">
              ...
              >
                ...
                >
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 max-w-[80%] border border-white/10">
                    <p className="text-sm text-slate-200">
                      Systems nominal. 👋 I'm analyzing real-time intent to
                      orchestrate your revenue pipeline.
                    </p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="bg-linear-to-r from-blue-600 to-cyan-600 rounded-2xl rounded-tr-none p-4 max-w-[80%]">
                    <p className="text-sm text-white">What's my current ROI?</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div className="bg-white/5 backdrop-blur-sm rounded-2xl rounded-tl-none p-4 max-w-[80%] border border-white/10">
                    <p className="text-sm text-slate-200 mb-3">
                      I identify high-value opportunities and bridge the gap
                      between intent and attribution.
                    </p>
            ...
            <div className="absolute -right-4 bottom-1/4 bg-slate-800/90 backdrop-blur-xl rounded-xl p-4 border border-white/10 shadow-md hidden lg:block animate-float-delayed">
              ...
              <div className="text-xs text-slate-400">Revenue Alpha</div>
            </div>
          </div>
        </div>
      </motion.div>
