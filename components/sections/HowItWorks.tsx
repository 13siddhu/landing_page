  ...
  const steps = [
    {
      ...
      description: "Passive integration into your growth ecosystem via our zero-friction API.",
      icon: Code,
      color: "from-blue-500 to-cyan-500"
    },
    {
      number: "02",
      title: "Activate Growth Agents",
      description: "Neural models analyze intent in real-time, orchestrating personalized engagement flows.",
      icon: MessageSquareText,
      color: "from-cyan-500 to-purple-500"
    },
    {
      number: "03",
      title: "Orchestrate Revenue",
      description: "High-velocity pipeline is synchronized directly with your CRM and attribution metrics.",
      icon: CalendarCheck,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 lg:mb-16">
          ...
          <p className="how-sub text-lg sm:text-xl text-slate-400">
            Deploy, Analyze, and Orchestrate in sub-second intervals.
          </p>
        </div>
        ...
        <div className="how-footer text-center mt-12 lg:mt-16">
          <p className="text-sm text-slate-500">
            Enterprise Security • SOC2 Compliant • Global Scalability
          </p>
        </div>
      </div>
    </section>
